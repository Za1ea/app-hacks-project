...
function SimulationCO2() {
  ...
  return (
    <div className="content-container align-center">
      ...
      <p>Choose how many trees you want to plant and our simulator will tell you how CO2 emissions will be affected<br/>
      Hover over a country to see its CO₂ Emissions in megatonnes (million metric tons)</p>
      <ChoroplethMap scaleFactor={scaleFactor} />
      <div style={{ display: "flex" }}>
        <InputSlider onChange={setSliderValue} labelText={"Hectares of trees in hundreds of thousands"}/>
      </div>
      <div className="text-container align-left">
        <h3>Interesting Facts about trees and CO2</h3>
        <ul>
          <li> Though trees cannot completely reverse climate change, they are able to capture a significant amount of carbon during their growth. 1 hectare (10,000 square meters) of trees can capture approximately 163.293 tons of CO2 in the atmosphere.  </li>
