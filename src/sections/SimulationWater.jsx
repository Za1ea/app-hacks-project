...
function SimulationWater() {
  ...
  const scaleFactor = (37315.18 - sliderValue * 1000000 * (40 / 1000000)) / 37315.18

  return (
    <div className="content-container align-center">
      <h1>Every Gallon</h1>
      <p>See how much the global CO₂ emissions drop based on how many gallons of water are conserved. (Every 1 million gallons conserved, or 51 cubic feet of water, saves 40 tonnes of carbon emissions annually)<br/>
      ...
      <div style={{ display: "flex" }}>
        <InputSlider onChange={setSliderValue} page={"water"} labelText={"Gallons of water saved (millions)"} maxValue={500}/>
      </div>
      <div className="text-container align-left">  
        <ul>
            <li> About every cubic meter of water consumed generates 10.5 kg of carbon emissions, or around 85 pounds of carbon for every 1,000 gallons of water. (For reference, there is about 88,263 cubic feet of water in one Olympic swimming pool) </li>
